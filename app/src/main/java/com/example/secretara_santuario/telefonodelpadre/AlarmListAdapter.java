	...
	public View getView(int position, View view, ViewGroup parent) {
		...
		btnToggle.setOnCheckedChangeListener(new OnCheckedChangeListener() {
			...
			public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
				((ListaAlarmasActivity) mContext).setAlarmEnabled(((Long) buttonView.getTag()).longValue(), isChecked);
			}
		});
		...
		view.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View view) {
				((ListaAlarmasActivity) mContext).nuevaAlarma(((Long) view.getTag()).longValue());
			}
		});
		...
		view.setOnLongClickListener(new OnLongClickListener() {
			...
			public boolean onLongClick(View view) {
				((ListaAlarmasActivity) mContext).deleteAlarm(((Long) view.getTag()).longValue());
				return true;
			}
		});
